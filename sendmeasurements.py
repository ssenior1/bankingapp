...
def sendMeasurements(userName, apiToken, eventDict, numberOfErrors, createdAt):
    ...
    postMeasures(location_dict, userName, apiToken)
    ...
    postMeasures(web_portal_dict, userName, apiToken)
    ...
    postMeasures(operating_system_dict, userName, apiToken)
    ...
    postMeasures(browser_dict, userName, apiToken)
